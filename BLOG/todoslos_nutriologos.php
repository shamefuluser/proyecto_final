...
// TODOS los nutriólogos activos
$stmt = $pdo->query("
    SELECT u.id, u.nombre, u.email, u.recomendado, p.especialidad, p.bio, p.foto_perfil,
    ...
    ORDER BY u.recomendado DESC, num_contactos DESC
");
...
<head>
    ...
    <title>Directorio Completo | Nutriologos - Bite & Balance</title>
...
<body>
    ...
    <section class="hero">
        <h2>Directorio de Nutriologos</h2>
        <p>Todos los profesionales disponibles en nuestra comunidad</p>
    </section>

    <div class="container">
        <h2 class="section-title">Nutriólogos Certificados</h2>
